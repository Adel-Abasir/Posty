            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" placeholder="E-mail"
                        class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email') border-red-400 @enderror" value="{{ old('email') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        placeholder="Please type your password again" class="bg-gray-100 border-2 w-full p-4 rounded-lg">
                </div>
                <div class="mb-4">
                    <button type="submit"
